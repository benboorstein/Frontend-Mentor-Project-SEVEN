...
const mountedApp = app.mount('#app') // QQQ: I think I'm going to have to make my main ul in the HTML file (currently with the id 'job-listings') have the id of "app", right?
...
/* just for reference, delete when done

<div id="list-rendering">
  <ol>
    <li v-for="dataArrObj in dataArr">
      {{ dataArrObj.company }}
    </li>
  </ol>
</div>
